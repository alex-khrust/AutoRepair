...
gulp.task('scripts', function () {
  return gulp.src([ // Берем все необходимые библиотеки
    ...
    'libs/bootstrap-4.3.1-dist/js/bootstrap.min.js', // Подключаем Bootstrap
    'fonts/fontawesome-free-5.9.0-web/js/all.min.js', //Подключаем шрифт fontawesome
...
gulp.task('css-libs', ['sass'], function () {
  return gulp.src([ // Выбираем файл для минификации
    ...
    // 'libs/bootstrap-4/bootstrap-grid.min.css',
